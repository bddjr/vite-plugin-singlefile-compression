...
<pre><code class="hljs language-ts"><span class="hljs-comment">// Restore scroll position after page reload or back/forward navigation</span>
{
  ...
  <span class="hljs-keyword">if</span> (item !== <span class="hljs-literal">null</span>) {
    <span class="hljs-keyword">try</span> {
      ...
      <span class="hljs-keyword">const</span> navEntry = self.<span class="hljs-property">performance</span>.<span class="hljs-title function_">getEntriesByType</span>(<span class="hljs-string">&#x27;navigation&#x27;</span>)[<span class="hljs-number">0</span>] <span class="hljs-keyword">as</span>
        | <span class="hljs-title class_">PerformanceNavigationTiming</span>
      ...
      <span class="hljs-keyword">if</span> (navType === <span class="hljs-string">&#x27;reload&#x27;</span> || navType === <span class="hljs-string">&#x27;back_forward&#x27;</span>) {
        ...
        <span class="hljs-built_in">setTimeout</span>(<span class="hljs-function">() =&gt;</span> {
          self.<span class="hljs-title function_">scrollTo</span>({
